...
The 1st of may, the student starts studying a initialDeck of cards, it is composed of three cards A, B and C (sort in alphabetic order by question name).
The student puts the card A in the red box, the B card in the green box and the C card in the orange box.
...
The 2nd of may, the student starts another session, the cards he needs to study are in the red box. He studies the card A, and remember the answer pretty well and put it in the green box. He studies the card C and he stills have hard time to remember it perfectly and put it again in the orange box.
...
The goal of the exercise is : based on a file containing all the cards of a initialDeck about art, to simulate the study sessions day by day. The user will run the program every day and the session will be interactive. The state at the end of a session can be stored in a file, the program will then say goodbye and stop.
When the user will run it again the next day it will automatically load the file containing the cards to study.
